...
cdef extern from "ueye.h":
    ...
    ctypedef struct UEYE_CAMERA_INFO:
    ...
    ctypedef struct UEYE_CAMERA_LIST:
    ...
    cdef int is_GetCameraList(UEYE_CAMERA_LIST *pucl)
    ...
    ctypedef struct UEYE_CAPTURE_STATUS_INFO:
